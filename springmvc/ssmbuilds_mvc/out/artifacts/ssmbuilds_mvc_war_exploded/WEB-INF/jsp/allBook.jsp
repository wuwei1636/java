                ...
                <tbody>
                    <c:forEach var="book" items="${list}">
                        <tr>
                            ...
                            <td>${book.detail}</td>
                            <td>
                                <a href="${pageContext.request.contextPath}/book/tochangeBook/${book.bookID}">修改</a>
<%--                                <a href="${pageContext.request.contextPath}/book/tochangeBook?id=${book.bookID}}">修改</a>--%>
                                &nbsp; | &nbsp;
